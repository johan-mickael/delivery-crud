<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import = "ramorasata.Axe" %>
<% Object[] tab = (Object[]) request.getAttribute("axe");
...
<div class="limiter">
		...
		<div class="ml-4 mt-4"><a href="/gestionlivraison/ListeServlet.html">Retour</a></div>
				<form class="login100-form validate-form" action="/gestionlivraison/InsertionLivreurServlet" method="post">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Le produit est requis">
						<span class="label-input100">Nom</span>
						<input type="text" name="nom" class="input100">
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-26" data-validate="Le produit est requis">
						<span class="label-input100">Prenom</span>
						<input type="text" name="prenom" class="input100">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="La date est requis">
						...
						<input type="date" name="dateEntree" class="input100">
						<span class="focus-input100"></span>
					</div>
